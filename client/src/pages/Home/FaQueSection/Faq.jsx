    ...
    <div className="w-full  pt-16">
      <div className="w-80 md:w-full lg:w-96 rounded-2xl bg-white p-2 text-[#142441]">
        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className="flex w-full justify-between rounded-lg   text-left text-lg md:text-xl font-semibold  py-5 shadow-xl ">
        ...
        <Disclosure as="div" className="mt-9  shadow-xl ">
          {({ open }) => (
            <>
              <Disclosure.Button className="flex w-full justify-between rounded-lg   text-left text-xl font-semibold  py-5 ">
