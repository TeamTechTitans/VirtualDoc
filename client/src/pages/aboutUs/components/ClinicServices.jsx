        ...
        <Card className="md:w-96 w-full shadow-2xl group mx-auto my-6 ">
          <CardHeader className="relative md:h-56 h-full">
            <img
              ...
              alt="card-image"
              className="md:w-96 w-full transition ease-in-out group-hover:scale-110 delay-150"
            />
          </CardHeader>
          <CardBody className="relative">
            ...
            <Typography
              variant="h5"
              color="blue-gray"
              className="mb-2 mt-4 delay-150 text-center font-barlow group-hover:text-primary-teal"
            >
        ...
        <Card className="md:w-96 w-full shadow-2xl group mx-auto my-6 ">
          <CardHeader className="relative md:h-56 h-full ">
            <img
              ...
              alt="card-image"
              className="w-96 transition ease-in-out group-hover:scale-110 delay-150"
            />
          </CardHeader>
          <CardBody className="relative">
            <div className="absolute border-0 w-20 h-20 p-3 delay-150 -top-12 left-36 rounded-full border-black group-hover:border-white group-hover:bg-blue-100 bg-white">
