...
const DoctorProfile = () => {
    ...
    const handleUpdateForm = async (e) => {
        ...
        const res = await axiosPublic.put(`/doctor/${doctor.email}`,updateUserData)
                ...
                <Card className="mt-20">
                    ...
                    <CardBody>
                        ...
                        <div className='grid lg:grid-cols-2 grid-cols-1 gap-4'>
                            <div className="w-72">
                                <Input defaultValue={doctor?.name} name="u_name" label="Username" />
                            </div>
                            <div className="w-72">
                                <Input readOnly defaultValue={doctor?.email} name="u_email" label="Email" />
                            </div>
                            <div className="w-72">
                                <Input defaultValue={doctor?.loc} name="u_loc" label="Location" />
                            </div>
                            <div className="w-72">
                                <Input defaultValue={doctor?.blood_group} name="u_blood_group" label="Blood Group" />
                            </div>
                        </div>
                    </CardBody>
