...
const Dashboard = () => {
  return (
    <div className="grid grid-cols-12 gap-x-10 bg-gray-200">
      <div className="col-span-3">hello</div>
      <div className="col-span-9 w-11/12 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="bg-white h-32 p-3 w-full shadow-md rounded-lg my-5">
            ...
            <Progress
              className="h-1 w-52 rounded-md my-1 bg-pink-50"
              value={70}
              color="pink"
            />
          ...
          <div className="bg-white h-32 p-3 w-full shadow-md rounded-lg my-5">
            ...
            <Progress
              className="h-1 w-52 rounded-md my-1 bg-green-50"
              value={70}
              color="green"
            />
          ...
          <div className="bg-white h-32 p-3 w-full shadow-md rounded-lg my-5">
            ...
            <Progress
              className="h-1 w-52 rounded-md my-1 bg-yellow-50"
              value={70}
              color="yellow"
            />
