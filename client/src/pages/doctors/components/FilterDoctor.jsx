...
import { FaGlasses, FaMagnifyingGlass, FaSearchengin } from "react-icons/fa6";
    ...
    return (
        <div>
            <div className="mt-20 mb-10 flex justify-center items-center flex-col">
                ...
                <Typography variant="h2" className="text-black">Search or filter the doctors</Typography>
            </div>
            {/* Filter */}
            <div>
                <form>
                    <div className="flex items-center flex-col justify-center gap-5 md:flex-row mb-10 px-2">
                        ...
                        <div className="w-[200px]" >
                            <Input color="teal" id="searchId" label="Search by name" icon={<label htmlFor="searchId"><FaMagnifyingGlass className="cursor-pointer"></FaMagnifyingGlass></label>} />
                        </div>
                    </div>
                </form>
                    ...
                    <div className='text-center mb-10 mx-2'>
                        <nav aria-label="Page navigation example">
                            <ul className="inline-flex -space-x-px text-base h-10">
                                <li>
                                    <button className="flex items-center  text-2xl  justify-center px-4 h-10 ms-0 leading-tight text-gray-500 bg-white border border-e-0 border-gray-300 rounded-s-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">&#171;</button>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="#" className="flex text-2xl items-center justify-center px-4 h-10 leading-tight text-gray-500 bg-white border border-gray-300 rounded-e-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">&#187;</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
