...
const AboutResearch = () => {
    return (<div className='font-Barlow'>
      ...
      <CardHeader
        shadow={false}
        floated={false}
        className="m-0 sm:w-full lg:w-2/5 shrink-0 rounded-r-none"
      >
    <div className="relative md:ml-20 lg:ml-0">
      ...
      <CardBody className='font-Barlow'>
        <Typography variant="h6" color="" className="mb-4 font-Barlow uppercase text-primary-teal">
            About Research
        </Typography>
        <Typography variant="h2" color="" className="mb-4 uppercase text-black font-Barlow">
              Reliable Journal of Medical Health Research.
        </Typography>
        <Typography variant="" color="blue-gray" className="font-Barlow mb-2 text-xl">
