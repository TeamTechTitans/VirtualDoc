        ...
        <div className="flex relative mb-20 p-2 justify-center items-center">
            ...
            >
                <img src={doctor?.image}
                    ...
                    loading='lazy'
                />
                <div className='absolute bg-secondary-teal w-60 z-10 p-4 translate-x-1/2 right-1/2 rounded-3xl shadow-md -bottom-20 '>
                    <Typography variant='h6' className='text-center'>{doctor?.name}</Typography>
                    <Typography variant='paragraph' className='text-center'>{doctor?.health_category}, {doctor?.education}</Typography>
