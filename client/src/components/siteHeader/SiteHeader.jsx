...
const SiteHeader = ({ children, title }) => {
    return (
        <div className='bg-header-bg before:h-96 bg-cover bg-no-repeat before:absolute before:w-full before:bg-dark-blue before:opacity-85 flex justify-center items-center h-96 w-full'>
